For this project the task was to find the best performing product category and customer segment. With the data I was given access to, I created a query to find the answer, 
